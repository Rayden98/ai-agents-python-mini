# Building Effective Agents (LLM Workflows) in Pure Python

This project contains practical patterns and examples for building effective LLM-powered systems. Using OpenAI API, based on real-world implementations and lessons learned from working with production systems, these patterns focus on simplicity and composability rather than complex frameworks.
